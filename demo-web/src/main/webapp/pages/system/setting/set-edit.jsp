			...
			<table class="kv-table">
				<tbody>
					<tr>
						...
						<td class="kv-content">
							<input class="easyui-textbox" type="text" name="code" style="width:235px;height:35px;line-height:35px;" />
						</td>
			...
			<table class="kv-table">
				<tbody>
					<tr>
						...
						<td class="kv-content">
							<input name="bigFileSplit1" id="bigFileSplit1" style="width:235px;height:35px;line-height:35px;" value="公历会计年度" />
						</td>
						<td class="kv-label">会计制度</td>
						<td class="kv-content">
							<input class="easyui-textbox" type="text" id="bigFileSplit" name="bigFileSplit" style="width:235px;height:35px;line-height:35px;" />
						</td>
						<td class="kv-label">导出时默认电子表格</td>
						<td class="kv-content">
							<input type="radio" name="adminFlag" value="0">excel</input>
							<input type="radio" name="adminFlag" value="1">wps</input>
						</td>
					</tr>
					<tr>
						<td class="kv-label">录入凭证时现金流量</td>
						<td class="kv-content">
							<input type="checkbox" name="a" value="0">是</input>
						</td>
					...
					<tr>
						...
						<td class="kv-content" >
							<input class="easyui-numberspinner" type="text" name="code" style="height:35px;line-height:35px;"/>
						</td>
					...
					<tr>
						...
						<td class="kv-content"><input class="easyui-numberspinner" type="text" name="code" style="height:35px;line-height:35px;"/></td>
				...
				<tbody>
					...
					<tr>
						...
						<td class="kv-content" colspan="6">
							<input type="radio" name="adminFlag" value="0">不需要进销存核算</input>
							<input type="radio" name="adminFlag" value="1">需要进销存核算</input>
						</td>
					</tr>
				</tbody>
			</table>
